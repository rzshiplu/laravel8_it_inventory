...
<link rel="stylesheet" href="{{ asset('backend-theme/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
<!-- iCheck -->
...
<!-- overlayScrollbars -->
<link rel="stylesheet" href="{{ asset('backend-theme/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
